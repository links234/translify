"""
Django settings for translify project.
...
AUTH_USER_MODEL = "translifyapp.User"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "translifyapp.context_processor.default",
            ],
        },
    },
]
...
PUBLIC_STATE_PATHS = [
    (
        os.path.join(PROJECT_ROOT, "translifyapp/templates/PublicState.jstemplate"),
        os.path.join(PROJECT_ROOT, "translifyapp/static/js/PublicState.js")
    ),
]
...
WSGI_APPLICATION = 'translify.wsgi.application'
